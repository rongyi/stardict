...
func TestDictionary(t *testing.T) {
	f1, err := os.Open("/home/coder/go/src/github.com/rongyi/stardict/cmd/tosql/stardict-gaojihanyudacidian_fix-2.4.2/gaojihanyudacidian_fix.ifo")
	if err != nil {
		t.Fatalf("%s\n", "fail to create new dictionary")
	}
	defer f1.Close()
	f2, err := os.Open("/home/coder/go/src/github.com/rongyi/stardict/cmd/tosql/stardict-gaojihanyudacidian_fix-2.4.2/gaojihanyudacidian_fix.idx")
	if err != nil {
		t.Fatalf("%s\n", "fail to create new dictionary")
	}
	defer f2.Close()
	f3, err := os.Open("/home/coder/go/src/github.com/rongyi/stardict/cmd/tosql/stardict-gaojihanyudacidian_fix-2.4.2/gaojihanyudacidian_fix.dict.dz")
	if err != nil {
		t.Fatalf("%s\n", "fail to create new dictionary")
	}
	defer f3.Close()
